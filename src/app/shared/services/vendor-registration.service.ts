...
export class VendorRegistrationService {
   ...
   * @returns 
   */
  filterRiderAndDriverList(service: string, data: any): Observable<any> {
    return this.http.post(apiUrls.postFilterRiderAndDriverEndPoint(apiEndPoints[service]), data).pipe(
      map((response) => {
        return response;
      })
    )
   ...
   * @returns 
   */
  getRiderAndDriverDetails(riderId: string): Observable<any> {
    return this.http.get(apiUrls.getRiderAndDriverDetailsById(apiEndPoints[this.service], riderId)).pipe(
      map((response) => {
        return response;
      })
    )
   ...
   * @returns 
   */
  approveRiderAndDriver(riderId: string): Observable<any> {
    return this.http.post(apiUrls.postApproveRiderAndDriverById(apiEndPoints[this.service], riderId), {}).pipe(
      map((response) => {
        return response;
      })
    )
   ...
   * @returns 
   */
  rejectRiderAndDriver(riderId: string): Observable<any> {
    const data = {
      reject_reason: this.remarks
    }
    return this.http.post(apiUrls.postRejectRiderAndDriverById(apiEndPoints[this.service], riderId), data).pipe(
      map((response) => {
        return response;
      })
    )
