...
// APIs for Rider& Driver Service
export const postFilterRiderAndDriverEndPoint = (apiEndPoint: IApiEndPoint) => {
  return `${environment.baseUrl}/${apiEndPoint.service}/admin/filter`;
};
export const getRiderAndDriverDetailsById = (apiEndPoint: IApiEndPoint, riderId: string) => {
  return `${environment.baseUrl}/${apiEndPoint.service}/admin/onboarding/${riderId}`;
}
export const postApproveRiderAndDriverById = (apiEndPoint: IApiEndPoint, riderId: string) => {
  return `${environment.baseUrl}/${apiEndPoint.service}/admin/onboarding/approve/${riderId}`;
}
export const postRejectRiderAndDriverById = (apiEndPoint: IApiEndPoint, riderId: string) => {
